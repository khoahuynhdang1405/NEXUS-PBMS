...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Tải dữ liệu ban đầu từ máy chủ
    ...
    function initSettingsView() {
        ...
        document.getElementById("rate-car").value = data.rates.car;
        document.getElementById("rate-suv").value = data.rates.suv;
        document.getElementById("rate-ev").value = data.rates.ev;
        document.getElementById("rate-motorbike").value = data.rates.motorbike;
        document.getElementById("rate-handicap").value = data.rates.handicap;
        document.getElementById("rate-ev-surcharge").value = data.rates.evChargingSurcharge;
    ...
    function renderUsersTable() {
        ...
        if (userList.length === 0) {
            tableBody.innerHTML = `
                <tr>
                    <td colspan="${currentRole === 'admin' ? 8 : 7}" style="text-align: center; color: var(--text-muted); padding: 24px;">
